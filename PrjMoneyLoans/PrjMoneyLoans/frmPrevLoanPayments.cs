...
{
    public partial class frmPrevLoanPayments : Form
    {
        ...
        private static frmPrevLoanPayments inst;
        public static frmPrevLoanPayments GetForm
        {
            get
            {
                if (inst == null || inst.IsDisposed)
                    inst = new frmPrevLoanPayments();
                return inst;
            }
        }
        ...
        {
          //Get all loans of AccountId That is  Finished all its amounts and  Remainder  is  Zero

            ClsSessionLoan.LoanAmount = MoneyLoansDb.GetLoans(AccountID: AccountID);
        ...
        private void frmPrevLoanPayments_Load(object sender, EventArgs e)
        {
        ...
        {
            int OptRemainder = (int)ClsSessionLoan.OptRemainder.All;
        ...
        private void grdLoans_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ClsSessionLoan.PaymentAmount = MoneyLoansDb.GetPaymentAmount(AccountID: AccountID, LoanEntryId: LoanEntryId);
            grdPayments.DataSource = ClsSessionLoan.PaymentAmount;
            
            //-------------

            ClsSessionLoan.DetailsLoanAmount = MoneyLoansDb.GetLoanTransactions(AccountID: AccountID, LoanEntryId: LoanEntryId);
        ...
        private void grdPayments_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ClsSessionLoan.DetailsLoanAmount = MoneyLoansDb.GetLoanTransactions(AccountID: AccountID, LoanEntryId: LoanEntryId,PaymentEntryId: PaymentEntryId);
            grdDetailsLoan.DataSource = ClsSessionLoan.DetailsLoanAmount;
